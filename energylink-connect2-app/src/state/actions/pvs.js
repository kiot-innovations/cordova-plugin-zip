...
export const SET_PVS_MODEL = createAction('SET_PVS_MODEL')
...
export const UPDATE_SN = createAction('UPDATE_SN')
...
export const RESET_METADATA_STATUS = createAction('RESET_METADATA_STATUS')
