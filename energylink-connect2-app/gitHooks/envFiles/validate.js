...
const appEnvs = ['dev', 'test', 'training', 'prod']
...
// Envs 'dev' and 'test' should contain the same keys,
// except for REACT_APP_IS_TEST and REACT_APP_IS_DEV.

// Envs 'training' and 'prod' should contain the same keys.

// Envs 'test' and 'training' should contain the same keys,
