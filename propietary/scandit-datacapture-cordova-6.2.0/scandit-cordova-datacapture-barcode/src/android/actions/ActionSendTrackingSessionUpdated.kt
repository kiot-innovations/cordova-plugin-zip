...
class ActionSendTrackingSessionUpdated(
    ...
    override fun run(args: JSONArray, callbackContext: CallbackContext): Boolean {
        try {
            ...
            listener.onSendTrackingSessionUpdatedActionExecuted(message, callbackContext)
    ...
    companion object {
        const val ACTION_NAME = "didUpdateSessionInBarcodeTracking"
    }

    interface ResultListener {
        fun onSendTrackingSessionUpdatedActionExecuted(
